...
| 状況 | 推奨アプローチ |
|---|---|
| ビルドツールあり、HTML の変更不可 | [CSS Modules](/docs/methodology/architecture/css-modules-strategy) または Tailwind `@apply` |
| ビルドツールなし、グローバル CSS のみ | [BEM 命名規約](/docs/methodology/architecture/bem-strategy) |
