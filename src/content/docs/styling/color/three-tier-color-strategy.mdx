...
- [Advanced Custom Properties](/docs/methodology/design-systems/custom-properties-advanced/) — Fallback chains, space toggles, and component APIs that implement the three-tier pattern
- [Theming Recipes](/docs/methodology/design-systems/custom-properties-advanced/theming-recipes) — Production-ready theme recipes using this architecture
- [Color Token Patterns](/docs/methodology/design-systems/tight-token-strategy/color-tokens) — Applying three-tier tokens in Tailwind's `@theme` system
- [Three-Tier Font-Size Strategy](../../typography/three-tier-font-size-strategy/) — The same three-tier architecture applied to font sizes
