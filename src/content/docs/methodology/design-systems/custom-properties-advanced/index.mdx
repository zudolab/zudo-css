...
Create layered configuration systems where a component checks for progressively broader defaults. This is the mechanism behind the [Three-Tier Color Strategy](/docs/styling/color/three-tier-color-strategy) — component tokens fall back to theme tokens, which fall back to palette values.
