...
The `--_` prefix tells readers "this variable is locally scoped to this component" — similar to how `_privateMethod` signals private scope in other languages. This is a documentation convention, not a CSS rule.
</Info>
