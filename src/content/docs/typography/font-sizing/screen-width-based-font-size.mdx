...
This article builds on [Fluid Font Sizing with clamp()](/docs/typography/font-sizing/fluid-font-sizing). Make sure you understand basic `clamp()` usage before reading further.
...
Prefer a single `clamp()` (covered in [Fluid Font Sizing](/docs/typography/font-sizing/fluid-font-sizing)) when:
